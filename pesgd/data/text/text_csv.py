...
import pandas as pd
from pesgd.constant.data import LABEL_ID_COLUMN_NAME
from pesgd.constant.data import TEXT_DATA_COLUMN_NAME


class TextCSV(Data):
    """The text dataset in CSV format."""

    def __init__(self, csv_path, label_columns=[], text_column="text", num_samples=None, rand_seed=42):
        """Constructor.
        ...
        if num_samples is not None:
            data_frame = data_frame.sample(frac=1., random_state=rand_seed, replace=False).reset_index(drop=True)
