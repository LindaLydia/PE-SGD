...
import torch
from pesgd.accountants import create_accountant
from pesgd.accountants.utils import get_noise_multiplier
from pesgd.data_loader import DPDataLoader, switch_generator
# from pesgd.distributed import DifferentiallyPrivateDistributedDataParallel as DPDDP
from pesgd.grad_sample import (
    AbstractGradSampleModule,
    GradSampleModule,
    get_gsm_class,
    wrap_model,
)
from pesgd.optimizers import PESGDOptimizer, DPOptimizer, get_optimizer_class
from pesgd.schedulers import _GradClipScheduler, _NoiseScheduler
# from pesgd.utils.fast_gradient_clipping_utils import DPLossFastGradientClipping
from pesgd.validators.module_validator import ModuleValidator
...
class PrivacyEngine:
    ...
    def __init__(self, *, accountant: str = "prv", secure_mode: bool = False):
        ...
        """
        # print(f"[debugging] in <./pesgd/privacy_engine.py> func <__init__> initializing PrivacyEngine with accountant={accountant}, secure_mode={secure_mode}")
    ...
    def _prepare_optimizer(
        ...
        *,
        ...
        inference_model: AbstractGradSampleModule,
        ...
        **kwargs,
        ...
        if isinstance(optimizer, PESGDOptimizer):
    ...
    #         optimizer: PESGDOptimizer used for training,
    ...
    def make_private(
        ...
        **kwargs,
        ...
        Tuple[GradSampleModule, PESGDOptimizer, DataLoader],
        # Tuple[GradSampleModule, PESGDOptimizer, DPLossFastGradientClipping, DataLoader],
    ]:
        """
        ...
        distributed = isinstance(module, (DDP, FSDPModule))
        ...
        # print(f"[debug] in file <pesgd.privacy_engine> func <PrivacyEngine.make_private> {sample_rate=}, should equal to args.priv_sampling_ratio")
    ...
    def make_private_with_epsilon(
        ...
        **kwargs,
        ...
        """
        sample_rate = 1 / len(data_loader)
        # print(f"[debug] in file <pesgd.privacy_engine> func <PrivacyEngine.make_private_with_epsilon> {sample_rate=}, should equal to args.priv_sampling_ratio")
    ...
    def save_checkpoint(
        ...
        *,
        ...
        module: GradSampleModule,
        optimizer: Optional[PESGDOptimizer] = None,
        ...
        Args:
            ...
            optimizer: PESGDOptimizer to save; wrapped optimizer's state_dict is saved.
