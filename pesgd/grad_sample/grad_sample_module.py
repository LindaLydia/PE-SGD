...
from pesgd.grad_sample.functorch import ft_compute_per_sample_gradient, prepare_layer
from pesgd.grad_sample.gsm_base import AbstractGradSampleModule
from pesgd.layers.dp_rnn import DPGRU, DPLSTM, DPRNN, RNNLinear
from pesgd.utils.module_utils import (
        ...
        *,
        ...
        Args:
            ...
            strict: If set to ``True``, the input module will be validated to make sure that none of its submodules includes buffers,
                which is not currently supported by PE-SGD.
        ...
        errors.extend(
            [
                NotImplementedError(
                    ...
                    f"that PE-SGD doesn't currently support({m_name}:{m}). "
                )
