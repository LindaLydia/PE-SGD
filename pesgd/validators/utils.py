...
def register_module_validator(
    ...
    ... def validate(module: nn.Module, **kwargs) -> List[pesgd.validators.errors.UnsupportedError]:
    ...    pass

    It may help you to take a look at the existing validator inside Opacus, under ``pesgd.validators.``
    """
...
def register_module_fixer(
    ...
    It may help you to take a look at the existing fixers inside Opacus, under ``pesgd.validators.``
    """
