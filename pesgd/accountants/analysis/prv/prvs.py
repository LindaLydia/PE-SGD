...
class PoissonSubsampledGaussianPRV:
    ...
    def __init__(self, sample_rate: float, noise_multiplier: float) -> None:
        # print(f"[debugging] in <./pesgd/accountants/analysis/priv/prvs.py>, Initializing PoissonSubsampledGaussianPRV with {sample_rate=}, {noise_multiplier=}")
    ...
    def cdf(self, t):
        ...
        # print(f"[debugging] in <./pesgd/accountants/analysis/priv/prvs.py>, {t=}, {q=}, {np.log(1 - q)=}, {np.exp(t) + q - 1=}, {(np.exp(t) + q - 1) / q=}")
